...
- `nightloop.example.toml` is the template used by `nightloop init`
- `targets/<name>.toml` contains named target configs generated by `nightloop init`
...
- no additional split tracking state is written
